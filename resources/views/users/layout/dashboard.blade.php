                          ...
                          <div class="timeline-container">
                              <ul class="vertical-scrollable-timeline" id="vertical-scrollable-timeline">
                                  ...
                                  <li>
                                      ...
                                      <h5 class="text-black">Anda bisa membantu mendanai proyek budidaya hewan ternak melalui Fitur GoatVest kami.</h5>
                                  ...
                                  <li>
                                      ...
                                      <h5 class="text-black">Mitra Peternak Goated, menjalankan budidaya dari dana hewan ternak yang anda setorkan.</h5>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="owl-testimonials owl-carousel">
              ...
              <div class="col-md-12">
                <div class="artikel-item">
                  <a href="{{ route('article-1') }}">
                    ...
                    <div class="down-content">
                      <h4><a href="{{ route('article-1') }}">Takut Kurban Online? Berikut Segudang Manfaat Kurban Online Dibanding Offline</a></h4>
                      <p>Bukan cuma infak dan zakat, kini berkurban juga sudah mulai menggunakan platform online. Hal ini tidak terlepas dari perkembangan dunia teknologi terutama kerjasama antara startup company dengan lembaga non-prof...</p>
                    </div>
                  </a>
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="artikel-item">
                  <a href="{{ route('article-2') }}">
                    <img src="home/assets/images/artikel-2.png" alt="">
                    <div class="down-content">
                      <h4><a href="{{ route('article-2') }}">Harga Hewan Kurban Naik Ngga Ya?</a></h4>
                      <p>Kenaikan harga hewan kurban menjelang Hari Raya Idul Adha menjadi hal yang lazim terjadi pasaran. “ Ya, sudah biasa kalo harga ternak naik tiap tahunnya”, ucap salah satu penjual. Mengutip berita tahun lalu, harga...</p>
                    </div>
                  </a>
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="artikel-item">
                  <a href="{{ route('article-3') }}">
                    <img src="home/assets/images/artikel-3.png" alt="">
                    <div class="down-content">
                      <h4><a href="{{ route('article-3') }}">Solusi ini Membantumu Agar Miliki Dana untuk Berkurban di Tiap Tahunnya!</a></h4>
                      <p>Beberapa tahun silam, sempat viral kisah seorang pemulung bernama Mak Yati dan hewan kurbannya. Bekerja sebagai pemulung, tidak menyurutkan niat tulus Mak Yati mengumpulkan dana untuk berkurban di Hari Raya Idul Adha...</p>
                    </div>
                  </a>
                </div>
              </div>
